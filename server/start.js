...
// -- This is the MAIN FILE that gets run in terminal when we run 'npm start'. All other files are basically referred simply through the below require statements
